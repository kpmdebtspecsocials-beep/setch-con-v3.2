...
const CreateReportScreen = ({ navigation }) => {
  ...
  const validateForm = () => {
    const { title, description, category, address, lat, lng } = formData;
    ...
    if (!address || !lat || !lng) {
      Alert.alert('Error', 'Please provide a location for the report');
      return false;
    }
    ...
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <AddressInput
          ...
          showGPSOption={true}
          required={true}
          error={!formData.address ? 'Location is required' : null}
        />
        ...
        <Button
          ...
          loading={loading}
          disabled={!formData.address || !formData.lat || !formData.lng}
